 ...
 */
final class Version20220216152829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lodging (id INT AUTO_INCREMENT NOT NULL, created_by_id INT NOT NULL, hygiene VARCHAR(255) NOT NULL, noise VARCHAR(255) NOT NULL, custumerbase VARCHAR(255) NOT NULL, atmosphere VARCHAR(255) NOT NULL, convenience VARCHAR(255) NOT NULL, demonstration VARCHAR(255) NOT NULL, partnership VARCHAR(255) NOT NULL, hostbehavior VARCHAR(255) NOT NULL, coworkingspace VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, selectlodging VARCHAR(255) NOT NULL, INDEX IDX_8D35182AB03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
